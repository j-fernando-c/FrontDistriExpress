...
import { getAllRoles, createRol, updateRol, deleteRol } from '../../api/rolesService';
 ...
 * 
 * Permite crear, leer, actualizar y eliminar registros de Roles.
...
const RolesPage = () => {
  ...
  // Fetch data
  const { data: items, loading, error, refetch } = useFetch(() => getAllRoles(), {
    autoFetch: true,
  });
