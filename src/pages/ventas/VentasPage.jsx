...
import { getAllVentas, createVenta, updateVenta, deleteVenta } from '../../api/ventasService';
 ...
 * 
 * Permite crear, leer, actualizar y eliminar registros de Ventas.
...
const VentasPage = () => {
  ...
  // Fetch data
  const { data: items, loading, error, refetch } = useFetch(() => getAllVentas(), {
    autoFetch: true,
  });
  ...
  return (
    <Card title="Gestión de Ventas">
      ...
      {/* Create/Edit Modal */}
      <Modal
        title={editingId ? 'Editar Venta' : 'Crear Venta'}
        isOpen={showModal}
        onClose={() => {
          toggleModal();
          setFormData({ cliente: '', fecha: '', total: '', estado: '' });
