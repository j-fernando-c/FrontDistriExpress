...
import { getAllCategorias, createCategoria, updateCategoria, deleteCategoria } from '../../api/categoriaProductosService';
 ...
 * 
 * Permite crear, leer, actualizar y eliminar registros de Categorías.
...
const CategoriasPage = () => {
  ...
  // Fetch data
  const { data: items, loading, error, refetch } = useFetch(() => getAllCategorias(), {
    autoFetch: true,
  });
